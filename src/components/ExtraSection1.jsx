...
//     <div className="grid sm:grid-cols-3 lg:grid-cols- gap-6 px-6">
  ...
  <section className="my-10 bg-gradient-to-r from-pink-100 to-purple-100 py-12 rounded-2xl text-center shadow-md">
    ...
    <div className="grid sm:grid-cols-3 gap-6 px-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition flex flex-col h-full">
        <img src={diykit} alt="Art Kit" className="rounded-lg mb-3 mx-auto h-40 object-cover" />
        <h3 className="font-semibold text-purple-600">DIY Art Kits</h3>
      ...
      {/* Card 2 */}
      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition flex flex-col h-full">
        <img src={blockimg} alt="Building Blocks" className="rounded-lg mb-3 mx-auto h-40 object-cover" />
        <h3 className="font-semibold text-purple-600">Building Blocks</h3>
        <p className="text-sm text-gray-500 mt-1 flex-grow">
          Perfect for little engineers! Build, rebuild, and bring their
          imagination to life.
      ...
      {/* Card 3 */}
      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition flex flex-col h-full">
        <img src={craftimg} alt="Craft Toys" className="rounded-lg mb-3 mx-auto h-40 object-cover" />
        <h3 className="font-semibold text-purple-600">Craft Toys</h3>
        <p className="text-sm text-gray-500 mt-1 flex-grow">
          From clay modeling to origami, develop fine motor skills while having
          fun!
