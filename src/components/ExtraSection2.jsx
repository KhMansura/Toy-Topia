// const ExtraSection2 = () => (
//   <section className="my-10 py-10 rounded-2xl text-center bg-purple-100">
//     <h2 className="text-3xl font-bold mb-4 text-primary">
//       🧠 Learn Through Play
//     </h2>
//     <p className="max-w-2xl mx-auto text-purple-400">
//       Toys that teach! Browse our educational games and STEM sets to make
//       learning fun and engaging for every child.
//     </p>
//   </section>
// );
  ...
  <section className="my-10 py-12 rounded-2xl text-center bg-purple-50 shadow-md">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 px-6">
      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition">
        <img src={science} alt="Science Kit" className="rounded-lg mb-3 mx-auto" />
        <h3 className="font-semibold text-purple-600">Science Kits</h3>
        <p className="text-sm text-gray-500 mt-1">Hands-on experiments that spark curiosity about chemistry and physics.</p>
      </div>

      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition">
        <img src={mathimg} alt="Math Game" className="rounded-lg mb-3 mx-auto" />
        <h3 className="font-semibold text-purple-600">Math Games</h3>
        <p className="text-sm text-gray-500 mt-1">Make problem-solving exciting with puzzles and logic challenges.</p>
      </div>

      <div className="bg-white rounded-xl p-6 shadow hover:shadow-lg transition">
        <img src={robot} alt="Robotics" className="rounded-lg mb-3 mx-auto" />
        <h3 className="font-semibold text-purple-600">Robotics</h3>
        <p className="text-sm text-gray-500 mt-1">Introduce kids to coding and robotics in a playful and easy way.</p>
      </div>
    </div>
